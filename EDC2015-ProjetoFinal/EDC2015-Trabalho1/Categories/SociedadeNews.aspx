<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SociedadeNews.aspx.cs" Inherits="EDC2015_Trabalho1.Categories.CienceNews" %>
    ...
    <asp:Repeater ID="Repeater1" runat="server" DataSourceID="XmlDataSource1" onitemcommand="rpt1_ItemCommand">
     <HeaderTemplate>
                ...
                <div class="col-lg-5 col-md-6 col-xs-12" >
                    <div class="well"  style="background-image:url(../images/Sociedade.jpg); min-height: 240px;">        
            ...
            <asp:XmlDataSource ID="XmlDataSource1" runat="server" DataFile="http://feeds.jn.pt/JN-Sociedade" TransformFile="~/feedinfo.xslt"></asp:XmlDataSource>
           <div class="row"></div> 
</asp:Content>
