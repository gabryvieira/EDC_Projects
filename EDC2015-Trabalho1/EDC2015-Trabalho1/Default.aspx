...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="XmlDataSource3" Font-Size="8pt" ForeColor="#333333" GridLines="None" AllowPaging="True" OnPageIndexChanged="GridView1_PageIndexChanged" CssClass="table" AutoGenerateColumns="False" OnDataBound="GridView1_DataBound1">
