...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-md-2">
            <asp:Button ID="add_rss" runat="server" OnClick="add_rss_Click" Text="Add New Rss" CssClass="form-control" Width="150"/>
        </div>
        <div class="col-md-5">
...
&nbsp;
<br />
<asp:Button ID="submit" runat="server" Enabled="False" OnClick="submit_Click" Text="Submit" Visible="False" />
    <p></p>
